function model_results = run_bootstrap_plsr(X, Y, cfg, model_results)

% Run bootstrap analysis for PLSR
% Joseph Griffis 2024
...
bootfun = @(IV,DV) run_boot_plsr(IV,DV,opt_k); % returns r-squared, betas, and vip
if cfg.parallel == 1
