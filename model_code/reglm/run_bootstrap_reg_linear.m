function model_results = run_bootstrap_reg_linear(X, Y, cfg, model_results)
...
bootfun = @(IV, DV) run_boot_regmdl(IV, DV, lambda, learner, reg_type); % returns R^2, AIC, and betas as a vector
if cfg.parallel == 1
