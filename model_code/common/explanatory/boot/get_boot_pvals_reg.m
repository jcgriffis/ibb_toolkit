function model_results = get_boot_pvals_reg(stat, bootstat, model_results, cfg)
...
model_results.boot.p_coeff = p_boot(2:end)';
model_results.boot.z_coeff = z_stats(2:end)';
