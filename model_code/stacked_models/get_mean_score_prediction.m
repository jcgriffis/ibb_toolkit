function stacked_results = get_mean_score_prediction(x_train, y_train, x_test,y_test, cfg, stacked_results,i,j)
...
stacked_results.classrate(i,j,3) = numel(find(pred_y==y_test))./length(y_test);
